...
1. In the third Command Line tool start application with `mvn -f ./system-eureka-naming-server-service spring-boot:run`
1. (Optional) Visit Eureca Connsole with `http://localhost:8761`
