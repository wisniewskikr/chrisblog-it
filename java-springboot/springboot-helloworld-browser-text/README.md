...
##### Goal
The goal of this project is to present how to display **Hello World** message in a **text** format in a **browser** by **Java** application using **Spring Boot** framework.

##### Details
The application displays message "Hello World" in a text format in a browser. 
