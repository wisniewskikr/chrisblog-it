...
##### Goal
The goal of this project is to present how to display **Hello World** message in a **JSON** format in a **browser** by **Java** application using **Spring Boot** framework.
